...
type context = Typechecker_common.context
...
(** Creates a new typechecking context. It only contains builtin and native
    declarations. *)

val check_program : context -> Ast.program -> Tast.program
